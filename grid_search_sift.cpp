...
int main(int argc, char* argv[])
{
    ...
    cout << "============================================================" << endl;
    cout << "Dataset: " << dataset_dir << endl << endl;
    ...
    cout << "  Groundtruth: " << groundtruth.size() << endl << endl;
    ...
    cout << "  M: ";
    for (int m : M_values) cout << m << " ";
    cout << endl;
    cout << "  ef_construction: ";
    for (int ef : ef_construction_values) cout << ef << " ";
    cout << endl;
    cout << "  ef_search: ";
    for (int ef : ef_search_values) cout << ef << " ";
    cout << endl;
    cout << "  Total combinations: " << total_combinations << endl << endl;
    ...
    for (const auto& r : results) {
        if (r.recall_10 > best_recall.recall_10) best_recall = r;
        if (r.avg_search_ms < best_speed.avg_search_ms) best_speed = r;
        if (r.score > best_score.score) best_score = r;
    }
    ...
    cout << "  Recall@10: " << fixed << setprecision(4) << best_recall.recall_10 
         << ", Query time: " << fixed << setprecision(2) << best_recall.avg_search_ms << "ms" << endl << endl;
    ...
    cout << "  Query time: " << fixed << setprecision(2) << best_speed.avg_search_ms << "ms"
         << ", Recall@10: " << fixed << setprecision(4) << best_speed.recall_10 << endl << endl;
    ...
    cout << "  Score: " << fixed << setprecision(2) << best_score.score
         ...
         << ", Query time: " << fixed << setprecision(2) << best_score.avg_search_ms << "ms" << endl << endl;
    ...
    if (md_file.is_open()) {
        ...
        md_file << "- M: ";
        for (int m : M_values) md_file << m << " ";
        md_file << "\n- ef_construction: ";
        for (int ef : ef_construction_values) md_file << ef << " ";
        md_file << "\n- ef_search: ";
        for (int ef : ef_search_values) md_file << ef << " ";
